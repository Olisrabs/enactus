      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-5 mb-4">
          <div class="card h-100 shadow-sm border-0">
            <img src="assest/posfill.png" class="card-img-top" alt="Product 1">
            <div class="card-body">
              <h5 class="card-title">Product One [ poshfil ]</h5>
              <p class="card-text">Our premium shoe polish delivers a rich, long-lasting shine while nourishing and
                protecting your leather. Whether for daily wear or special occasions, it restores color, hides scuffs,
                and keeps your shoes looking sharp and professional. Easy to apply. Perfect for all leather types</p>
              <a href="blog.php" class="btn btn-warning">Learn More</a>
              <a href="https://poshfil.vercel.app/" class="btn btn-primary">purchase</a>
            </div>
          </div>
        </div>
        ...
        <!-- <div class="col-md-5 mb-4">
        <div class="card h-100 shadow-sm border-0">
          <img src="https://via.placeholder.com/500x300?text=Product+2" class="card-img-top" alt="Product 2">
          <div class="card-body">
            <h5 class="card-title">Product Two</h5>
            <p class="card-text">A brief description of your second product and the value it offers.</p>
